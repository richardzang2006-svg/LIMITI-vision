...
$$
\begin{gathered} x=f \cdot \frac{x_c}{z_c}, y=f \cdot \frac{y_c}{z_c} \\ z_c\left[\begin{array}{l} x \\ y \\ 1 \end{array}\right]=\left[\begin{array}{llll} f & 0 & 0 & 0 \\ 0 & f & 0 & 0 \\ 0 & 0 & 1 & 0 \end{array}\right]\left[\begin{array}{c} x_c \\ y_c \\ z_c \\ 1 \end{array}\right] \end{gathered}
$$
...
$$
\begin{gathered} \left\{\begin{array}{l} u=u_0+\frac{x}{d x} \\ v=v_0+\frac{y}{d y} \end{array}\right. \\ {\left[\begin{array}{l} u \\ v \\ 1 \end{array}\right]=\left[\begin{array}{lll} \frac{1}{d x} & 0 & u_0 \\ 0 & \frac{1}{d y} & v_0 \\ 0 & 0 & 1 \end{array}\right]\left[\begin{array}{l} x \\ y \\ 1 \end{array}\right]} \end{gathered}
$$

#### 4.综合公式，我们就可以直接得到，从世界坐标系到像素坐标系的转换关系式：

![image-20251121204533454](/home/richard/.config/Typora/typora-user-images/image-20251121204533454.png)
...
![image-20251121220847793](/home/richard/.config/Typora/typora-user-images/image-20251121220847793.png)

得到标定结果后，保存在工作区，参数如图所示：

![image-20251121221048402](/home/richard/.config/Typora/typora-user-images/image-20251121221048402.png)
